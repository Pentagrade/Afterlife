...
export default defineConfig({
  ...
  head: [
    ...
    [
      'link',
      { href: 'https://fonts.googleapis.com/css2?family=Bruno+Ace+SC&family=Gemunu+Libre:wght@200..800&display=swap', rel: 'stylesheet' }
    ]
  ],
    ...
    sidebar: [
      {
        text: 'Guides',
        items: [
          { text: '👁️‍🗨️ Privacy', link: '/guides/privacy' },
          { text: '🔒 OPSEC', link: '/guides/opsec' },
          { text: '🔍 OSINT', link: '/guides/osint' },
          { text: '💻 FOSS', link: '/guides/foss' },
          { text: '🏴‍☠️ Piracy', link: '/guides/piracy' }
        ]
      }
    ]
  }
